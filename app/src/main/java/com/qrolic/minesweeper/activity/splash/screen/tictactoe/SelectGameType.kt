...
@Composable
fun SelectGameType(navController: NavController) {
        ...
        Column(
            ...
            Button(
                onClick = {
                    ...
                    navController.navigate(Screen.SelectBoardSize.route + "/$type1")
            ...
            Button(onClick = {
                context.playSoundClick()
                navController.navigate(Screen.SelectBoardSize.route + "/$type2")
            }, modifier = Modifier.padding(10.dp)) {
                Text(
